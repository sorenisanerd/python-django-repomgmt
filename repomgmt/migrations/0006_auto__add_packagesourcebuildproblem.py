...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PackageSourceBuildProblem'
        db.create_table('repomgmt_packagesourcebuildproblem', (
            ...
            ('code_rev', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('pkg_rev', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal('repomgmt', ['PackageSourceBuildProblem'])


    def backwards(self, orm):
        # Deleting model 'PackageSourceBuildProblem'
        db.delete_table('repomgmt_packagesourcebuildproblem')
