...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.update_from'
        db.add_column('repomgmt_series', 'update_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repomgmt.Series'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.update_from'
        db.delete_column('repomgmt_series', 'update_from_id')
