...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TarballCacheEntry'
        db.create_table('repomgmt_tarballcacheentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('project_version', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('rev_id', self.gf('django.db.models.fields.CharField')(max_length=200, db_index=True)),
        ))
        db.send_create_signal('repomgmt', ['TarballCacheEntry'])

        # Adding model 'Subscription'
        db.create_table('repomgmt_subscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repomgmt.PackageSource'])),
            ('target_series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repomgmt.Series'])),
            ('counter', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('repomgmt', ['Subscription'])

        # Adding model 'PackageSource'
        db.create_table('repomgmt_packagesource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('code_url', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('packaging_url', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('last_seen_code_rev', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('last_seen_pkg_rev', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('flavor', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('repomgmt', ['PackageSource'])


    def backwards(self, orm):
        # Deleting model 'TarballCacheEntry'
        db.delete_table('repomgmt_tarballcacheentry')

        # Deleting model 'Subscription'
        db.delete_table('repomgmt_subscription')

        # Deleting model 'PackageSource'
        db.delete_table('repomgmt_packagesource')
    ...
    models = {
        ...
        'repomgmt.tarballcacheentry': {
            ...
            'rev_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'})
        },
