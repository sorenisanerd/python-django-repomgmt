...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageSource.last_changed'
        db.add_column('repomgmt_packagesource', 'last_changed',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageSource.last_changed'
        db.delete_column('repomgmt_packagesource', 'last_changed')
