...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildRecord.finished'
        db.add_column('repomgmt_buildrecord', 'finished',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuildRecord.finished'
        db.delete_column('repomgmt_buildrecord', 'finished')
